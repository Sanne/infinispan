...
public class InfinispanIndexOutput extends IndexOutput {
   ...
   public InfinispanIndexOutput(final AdvancedCache<FileCacheKey, FileMetadata> metadataCache, final AdvancedCache<ChunkCacheKey, Object> chunksCache,
         final FileCacheKey fileKey, final int bufferSize, final FileListOperations fileList, final int affinitySegmentId) {
